...
// "Product Designer | EdTech | Hybrid". Previously kept in sync with
// resumeDataEdtech.js; the `about` opener is now deliberately broader than the
// EdTech variant's, so the two no longer match verbatim.
